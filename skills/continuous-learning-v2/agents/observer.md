...
A background agent that analyzes observations from AntiGravity Agent sessions to detect patterns and create instincts.
...
- Project: `${XDG_DATA_HOME:-~/.local/share}/monster-antigravity-homunculus/projects/<project-hash>/observations.jsonl`
- Global fallback: `${XDG_DATA_HOME:-~/.local/share}/monster-antigravity-homunculus/observations.jsonl`
...
### 1. User Corrections
When a user's follow-up message corrects AntiGravity's previous action:
...
- Project: `${XDG_DATA_HOME:-~/.local/share}/monster-antigravity-homunculus/projects/<project-hash>/instincts/personal/`
- Global: `${XDG_DATA_HOME:-~/.local/share}/monster-antigravity-homunculus/instincts/personal/` (for universal patterns)
