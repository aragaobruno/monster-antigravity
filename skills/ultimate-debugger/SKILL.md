...
description: Meticulous XML-structured debugging workflow. Use when the user reports an error, bug, exception, stack trace, or crash, and wants a systematic root-cause analysis and step-by-step resolution instructions.
---
...
> **Monster AntiGravity-AI / Ultimate-Debugger-Prompt** no GitHub. Credite a fonte original ao
...
> **Credito:** prompt original de **Monster AntiGravity-AI / Ultimate-Debugger-Prompt** (GitHub),
