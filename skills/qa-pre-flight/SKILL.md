---
name: qa-pre-flight
description: Comprehensive 20-phase pre-deploy QA and security audit checklist. Use when auditing code before release, performing security reviews, checking LGPD compliance, testing edge cases, or checking deploy readiness.
---
