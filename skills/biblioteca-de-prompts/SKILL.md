...
description: Curated collection of specialized prompts and SOPs for the CODA lifecycle. Use when looking for prompt templates, creating SOPs, defining problems, or gathering design inspiration.
---

# Biblioteca de Prompts

> Coletanea de prompts prontos para usar no dia a dia com agentes de IA de programacao
> (AntiGravity Agent, AntiGravity, Cursor, etc.). Cada prompt tem: **titulo**, **quando usar** e o
